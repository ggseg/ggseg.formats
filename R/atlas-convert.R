...
convert_legacy_brain_atlas <- function(
  ...
  data <- switch(
    type,
    "cortical" = brain_data_cortical(sf = sf_data, vertices = vertices_df),
    "subcortical" = brain_data_subcortical(sf = sf_data, meshes = meshes_df),
    "tract" = brain_data_tract(sf = sf_data, meshes = meshes_df),
